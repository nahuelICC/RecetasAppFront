...
export const routes: Routes = [
  ...
  { path: 'crear-receta', component: CrearRecetaComponent, canActivate: [LoginGuard] },
  { path: 'cambioPassword', component: CambioPasswordComponent, canActivate: [LoginGuard] },
  { path: 'formResetPassword', component: FormularioCambioPasswordComponent, canActivate: [LoginGuard] },
